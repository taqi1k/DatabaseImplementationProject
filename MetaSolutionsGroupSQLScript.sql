...
FROM 'C:\Data\Production CSV.csv'
WITH (
	FORMAT = 'CSV',
	FIRSTROW = 2,
	FIELDTERMINATOR =',',
...
FROM 'C:\Data\Associative MP CSV.csv'
WITH (
	FORMAT = 'CSV',
	FIRSTROW = 2,
	FIELDTERMINATOR =',',
...
FROM 'C:\Data\Installation Address CSV.csv'
WITH (
	FORMAT = 'CSV',
	FIRSTROW = 2,
	FIELDTERMINATOR =',',
...
FROM 'C:\Data\Installation CSV.csv'
WITH (
	FORMAT = 'CSV',
	FIRSTROW = 2,
	FIELDTERMINATOR =',',
...
FROM 'C:\Data\Contractor CSV.csv'
WITH (
	FORMAT = 'CSV',
	FIRSTROW = 2,
	FIELDTERMINATOR =',',
...
FROM 'C:\Data\Fabricator CSV.csv'
WITH (
	FORMAT = 'CSV',
	FIRSTROW = 2,
	FIELDTERMINATOR =',',
